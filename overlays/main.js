...
var myThingy = {
  init: function() {
    window.addEventListener("keyup",    slashpreserver, true);
    window.addEventListener("keydown",  slashpreserver, true);
    window.addEventListener("keypress", slashpreserver, true);
  },
}

var slashpreserver = function (event) {
  ...
  if ( target.contentEditable == 'true'      ||
    ...
    var key_or_char_string = event.charCode
      ...
      : keyboardMap[event.keyCode];
    if ( typeof(key_or_char_string) == "string" ) {
      switch( key_or_char_string ) {
        case '/':
        case 'SLASH':
